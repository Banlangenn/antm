...
/**
 * 接口名：结口1
 * Rap 地址: http://rap2.taobao.org/repository/editor?id=284428&mod=486581&itf=2128188
 */
export const iUserInfoTestTypeDemo = createFetch<IUserInfo['request'], IUserInfo['response']>("/c/b/w/api/1.0/user", "GET");

/**
 * 接口名：接口2
 * Rap 地址: http://rap2.taobao.org/repository/editor?id=284428&mod=486581&itf=2128189
 */
...
/**
 * 接口名：我是刚刚新建的接口
 * Rap 地址: http://rap2.taobao.org/repository/editor?id=284428&mod=486581&itf=2128190
 */
